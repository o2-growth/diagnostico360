      ...
      <section className="py-24 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mt-3 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7EBF8E] to-[#00E676]">
              Descubra quais.
            </span>
          </h2>
          ...
          <button
            onClick={onCheckout}
            disabled={loading}
            className="px-10 py-5 rounded-2xl bg-gradient-to-r from-[#4CAF50] to-[#00E676] text-[#0A0A0A] font-black text-xl transition-all duration-300 hover:shadow-2xl hover:shadow-[#4CAF50]/40 hover:scale-[1.03] disabled:opacity-60"
          >
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#606060] text-sm">
              © {new Date().getFullYear()} O2 Inc. · Porto Alegre, RS
            </span>
          </div>

          <div className="flex items-center gap-6 text-[#505050] text-xs">
            <a href="mailto:contato@o2inc.com.br" className="hover:text-[#7EBF8E] transition-colors">
              contato@o2inc.com.br
            </a>
            <a href="https://www.o2inc.com.br" target="_blank" rel="noopener noreferrer" className="hover:text-[#7EBF8E] transition-colors">
              o2inc.com.br
            </a>
          </div>
        </div>
