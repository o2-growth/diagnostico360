    ...
    <section id="como-funciona" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div ref={headerRef} className="text-center mb-16">
          <span className="text-[#7EBF8E] text-xs font-bold uppercase tracking-widest">Metodologia</span>
          <h2 className="text-4xl md:text-5xl font-black text-white mt-3 leading-tight">Como funciona</h2>
          <p className="text-[#A0A0A0] text-lg mt-4 max-w-xl mx-auto">Simples, rápido e 100% orientado a resultados.</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <div className="text-[#303030] font-black text-5xl leading-none select-none">{step.number}</div>
                </div>
