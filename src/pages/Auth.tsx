      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-dashboard-muted">
            {isForgotPassword ? 'Recupere sua senha' : isLogin ? 'Entre na sua conta' : 'Crie sua conta'}
          </p>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {isLogin && (
                      <button
                        ...
                        className="text-xs text-dashboard-accent3 hover:underline font-medium transition-colors"
                      >
                        Esqueci minha senha
                      </button>
                    )}
